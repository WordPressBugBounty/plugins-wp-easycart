 ...
 *
 * Included by ec_subscription::send_subscription_trial_ending_email( $user ) ( runs as $this = ec_subscription ) with:
 ...
 *
 * Language strings kept: subscription_trial / subscription_trial_ending_email_title, trial_ending_message_1 … _4,
 * trial_ending_message_link.
 *
 * @package wp-easycart
 */
...
$ec_sub_title = $ec_sub_lang->get_text( 'subscription_trial', 'subscription_trial_ending_email_title' );
$ec_sub_link  = wpeasycart_links()->get_account_page( 'subscription_details', array( 'subscription_id' => (int) $this->subscription_id ) );
$ec_sub_intro = wp_kses_post( $ec_sub_lang->get_text( 'subscription_trial', 'trial_ending_message_1' ) ) . ' <strong style="color:#111827;">' . esc_html( $this->trial_period_days ) . '</strong> ' . wp_kses_post( $ec_sub_lang->get_text( 'subscription_trial', 'trial_ending_message_2' ) ) . ' <strong style="color:#111827;">' . esc_html( $this->title ) . '</strong> ' . wp_kses_post( $ec_sub_lang->get_text( 'subscription_trial', 'trial_ending_message_3' ) );
...
$ed::notice( wp_kses_post( $ec_sub_title ), 'warning' );
...
$ed::card_start();
$ed::paragraph( wp_kses_post( $ec_sub_lang->get_text( 'subscription_trial', 'trial_ending_message_4' ) ), array( 'tone' => 'small', 'margin' => '0' ) );
$ed::card_end();
$ed::section_end();

$ed::button_row( $ec_sub_link, $ec_sub_lang->get_text( 'subscription_trial', 'trial_ending_message_link' ), array( 'top' => 16, 'bottom' => 8, 'arrow' => true ) );
