jQuery(document).ready(function(){if(jQuery('.ec_add_to_cart_form, input[type="number"].ec_quantity').length){jQuery('.ec_add_to_cart_form, input[type="number"].ec_quantity').on('keypress',function(e){if(e.which==13){return!1}})}
