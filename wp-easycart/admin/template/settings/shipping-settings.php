...
if ( ! function_exists( 'ecv2_shipping_carrier_fields' ) ) {
	...
	function ecv2_shipping_carrier_fields() {
		...
		/* 6.0.1: moved here from "Live carrier rates" advanced — it only affects FedEx quotes. */
		$fields['ec_option_fedex_use_net_charge']             = ecv2_shipping_carrier_row( $c, $n, 'option', array( 'key' => 'ec_option_fedex_use_net_charge', 'type' => 'toggle', 'default' => 1, 'label' => __( 'Use FedEx account discounts', 'wp-easycart' ), 'desc' => __( 'Quotes your negotiated FedEx rates instead of list rates.', 'wp-easycart' ), 'advanced' => true, 'parent' => 'ec_option_fedex_use_oauth', 'legacy' => array( 'section' => 'Additional Shipping Options', 'label' => 'FedEx Account Discounts Apply' ) ) );
