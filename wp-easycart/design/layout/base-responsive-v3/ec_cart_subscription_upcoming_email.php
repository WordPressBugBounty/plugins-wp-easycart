		...
		<table width='539' border='0' align='center'>
			<tr>
				<td colspan='4' align='left' class='style22'>
					<img src='<?php echo esc_url( $email_logo_url ); ?>' style="max-height:250px; max-width:100%; height:auto;">
				</td>
			</tr>
			<tr>
				<td colspan='4' align='left' class='style22'>
					...
					<?php }?>
					<p><br><?php echo $GLOBALS['language']->get_text( 'subscription_upcoming', 'upcoming_details' ); ?> <?php echo esc_html( $this->title ); ?></p>
